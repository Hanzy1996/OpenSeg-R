...
def add_maskformer2_config(cfg):
    ...
    cfg.INPUT.DATASET_MAPPER_NAME = "mask_foqrmer_semantic"
    # Color augmentation
    ...
    cfg.MODEL.TEST_CLASS_REASON_JSON = "reason_data/general_reason/ade150_class_reason.json"
    cfg.MODEL.REASON_DIR = ("reason_data/image_reason/Qwen2.5-VL-72B-Instruct-AWQ")
    cfg.MODEL.REASON_DATA = ("reason_data/image_reason/Qwen2.5-VL-72B-Instruct-AWQ")
    cfg.MODEL.NUM_DES = 5
    cfg.MODEL.CLASS_NAME_JSON = None
    cfg.MODEL.CLIP_TYPE = "Convnext-B"
    cfg.MODEL.DATASET_NAME = "openvocab_ade20k_full_sem_seg_val"
